...
VALUES ('iso-8583-bi-conn', 1, '<codex id="iso-8583-bi-conn" escape="true">
 	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
 	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
 	<field id="bitmap" type="bitmap">
 		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
...
INSERT INTO MWCONFIG.CODEX (ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) 
VALUES ('iso-8583-cms', 0, '<codex id="iso-8583-cms" escape="true">
 	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
 	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
 	<field id="bitmap" type="bitmap">
 		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
 	...
 	<field id="!type" type="script" encode="true">iso-8583-cms</field>
 	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
 	<field id="!code" type="script" encode="true">${dtree("CMS-CODE", "messageType")}</field>
 </codex>
 ', CURRENT USER, CURRENT TIMESTAMP);

INSERT INTO MWCONFIG.CODEX (ID, XML, MODIFIED_BY, TIMESTAMP)
VALUES ('iso-8583-sms', '<codex id="iso-8583-sms" escape="true">
	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
	<field id="bitmap" type="bitmap">
		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
	...
	<field id="!type" type="script" encode="true">iso-8583-sms</field>
	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
	<field id="!code" type="script" encode="true">${dtree("SMS-CODE", "messageType")}</field>
</codex>', CURRENT USER, CURRENT TIMESTAMP);

INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) 
VALUES ('iso-8583-itmibft', 1,'<codex id="iso-8583-itmibft" escape="true">
	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
	<field id="bitmap" type="bitmap">
		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
...
INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) 
VALUES ('iso-8583-itm-instid', null,'<codex id="iso-8583-itm-instid" escape="true">
	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
	<field id="bitmap" type="bitmap">
		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
	...
	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
	<field id="!code" type="script" encode="true">${dtree("ITM-CODE", "messageType")}.${msg.additionalDataPrivate.substring(0,4).padLeft(4,"0")}</field>
</codex>', CURRENT USER, CURRENT TIMESTAMP);

INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) 
VALUES ('iso-8583-kpos-instid', 0,'<codex id="iso-8583-kpos" escape="true">
	...
	<field id="!type" type="script" encode="true">iso-8583-kpos</field>
	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
	<field id="!code" type="script" encode="true">${msg.messageType}.${msg.messageType.startsWith("08") ? msg.networkManagementInformationCode?.padLeft(6, "0") : msg.processingCode?.padLeft(6, "0")+"."+(msg.processingCode.equals("007540")?msg.additionalDataPrivate.substring(10,14):msg.processingCode.equals("007541")?msg.additionalDataPrivate.substring(105,109):msg.additionalDataPrivate.substring(143,147))}</field>
	<!--field id="!code" type="script" encode="true">${dtree("KPOS-CODE", "messageType")}</field-->
</codex>', CURRENT USER, CURRENT TIMESTAMP);

INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) 
VALUES ('iso-8583-sms-payment', 1, '<codex id="iso-8583-sms" escape="true">
 	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
 	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
 	<field id="bitmap" type="bitmap">
 		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
 	...
 	<field id="!type" type="script" encode="true">iso-8583-sms</field>
 	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
 	<field id="!code" type="script" encode="true">${msg.messageType}.${msg.messageType.startsWith("08") ? msg.networkManagementInformationCode?.padLeft(6, "0") : "1." + msg.reservedPrivate3?.trim()}</field>
 </codex>', CURRENT USER, CURRENT TIMESTAMP);

 INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) VALUES ('dsp-abcs-instcode', null,'<codex escape="true" raw="true">
	...
	<field id="!code" type="script" encode="true">${msg.dspScenarioNumber}.${msg.dspTransactionCode?.padLeft(10, "0")}.${msg.TLBTPN.tokenize('' '')[0]}${msg.TLBWC2 == "10" ? ".EC" : ""}</field>
	<field id="!parseCodex" type="script">${msg["!group"]}.${msg.dspTransactionCode?.padLeft(10, "0")}</field>
</codex>', CURRENT USER, CURRENT TIMESTAMP);

INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) 
VALUES ('iso-8583-itm', null,'<codex id="iso-8583-itm" escape="true">
	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" "/>
	<field id="bitmap" type="bitmap">
		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
...
INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) VALUES 
('iso-8583-sms-instid', null,'<codex id="iso-8583-sms-instid" escape="true">
  	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
  	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
  	<field id="bitmap" type="bitmap">
  		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
  	...
  	<field id="!type" type="script" encode="true">iso-8583-sms</field>
  	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
  	<field id="!code" type="script" encode="true">${dtree("SMS-CODE", "messageType")}.${msg.additionalDataPrivate.substring(0,4).padLeft(4,"0")}${msg.reservedPrivate2.startsWith("002")?".002":""}</field>
</codex>', CURRENT USER, CURRENT TIMESTAMP);


INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) VALUES ('iso-8583-sms-syariah', null, '<codex id="iso-8583-sms-syariah" escape="true">
  	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
  	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
  	<field id="bitmap" type="bitmap">
  		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
  	...
  	<field id="!type" type="script" encode="true">iso-8583-sms</field>
  	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
  	<field id="!code" type="script" encode="true">${dtree("SMS-CODE", "messageType")}.${msg.additionalDataPrivate.substring(0,4).padLeft(4,"0")}${msg.processingCode.startsWith("10")&amp;&amp;msg.reservedPrivate2.startsWith("002")?".002":""}</field>
  </codex>', CURRENT USER, CURRENT TIMESTAMP);

INSERT INTO MWCONFIG.CODEX(ID, ALLOW_PARTIAL, XML, MODIFIED_BY, TIMESTAMP) VALUES ('iso-8583-qris', null, '<codex id="iso-8583-qris" escape="true">
 	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
 	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
 	<field id="bitmap" type="bitmap">
 		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
 	...
 	<field id="!type" type="script" encode="true">iso-8583-qris</field>
 	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
 	<field id="!code" type="script" encode="true">${msg.messageType}.${msg.messageType.startsWith("08") ? msg.networkManagementInformationCode?.padLeft(6, "0") : msg.processingCode?.substring(0,2).padRight(6, "0")}</field>
 </codex>', CURRENT USER, CURRENT TIMESTAMP);

UPDATE MWCONFIG.CODEX SET XML = '<codex id="iso-8583-sms-syariah" escape="true">
  	<field id="packetLength" type="groupLengthBinary" decimal-format="binary" length="2" />
  	<field id="messageType" type="string" length="4" padding-mode="right" padding-char=" " />
  	<field id="bitmap" type="bitmap">
  		<field id="primaryAccountNumber" bit="2" type="string" length="19" format="llvar" />
  	...
  	<field id="!type" type="script" encode="true">iso-8583-sms</field>
  	<field id="!mid" type="script" encode="true">${msg.transmissionDateTime}.${msg.systemsTraceAuditNumber}</field>
  	<field id="!code" type="script" encode="true">${dtree("SMS-CODE", "messageType")}${msg.processingCode.startsWith("10")&amp;&amp;msg.reservedPrivate2.startsWith("002")?".002":""}</field>
  </codex>
  ' WHERE ID = 'iso-8583-sms-syariah';