 ...
 * @ Usage: CALL MWCONFIG.MERGE_ROUTING_TABLE(ID, CODE_START, CODE_END, CHANNEL, START_DATE, END_DATE, QUEUE, STATUS, SUBCODEX, ADDITIONAL, REPLY_TO, REPLY_TO_QMGR)
 */

CREATE OR REPLACE PROCEDURE MERGE_ROUTING_TABLE (
	...
	IN MODIFIED_BY VARCHAR(256) DEFAULT CURRENT USER,
	IN MODIFIED_DATE TIMESTAMP DEFAULT CURRENT TIMESTAMP
)
LANGUAGE SQL
BEGIN
